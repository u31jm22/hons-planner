#!/usr/bin/env python3
"""
Parse Gripper experiment logs into a CSV summary.
"""
...
OUT_CSV = EXP_DIR / "gripper_summary.csv"

LOG_PATTERN = re.compile(r"gripper_p(\d+)_([a-z]+)\.txt")
...
def main() -> int:
    ...
    for log_path in EXP_DIR.glob("gripper_p*.txt"):
