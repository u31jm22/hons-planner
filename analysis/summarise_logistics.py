#!/usr/bin/env python3
"""
Parse Logistics experiment logs into a CSV summary.
"""
...
OUT_CSV = EXP_DIR / "logistics_summary.csv"
LOG_PATTERN = re.compile(r"logistics_p(\d+)_([a-z]+)\.txt")
...
def main() -> int:
    ...
    # IMPORTANT: change glob to logistics_*.txt
    for log_path in EXP_DIR.glob("logistics_p*.txt"):
