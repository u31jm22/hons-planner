#!/usr/bin/env python3
"""
Generate and evaluate multiple LLM heuristic candidates for Logistics
on the TRAIN instances (p01–p03). Results go to notes/llm_candidates_logistics.csv.
"""
...
DOMAIN_PDDL = Path("domains/logistics/domain.pddl")
...
OUT_CSV = NOTES_DIR / "llm_candidates_logistics.csv"
...
def main():
    ...
    for k in range(1, N_CANDIDATES + 1):
        ...
        for inst in TRAIN_INSTANCES:
            ...
            summary_path = ROOT / "experiments" / "logistics_summary.csv"
