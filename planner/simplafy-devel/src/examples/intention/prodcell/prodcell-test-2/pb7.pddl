(define (problem pb7) (:domain prodcell)
(:objects 
    depositbelt - depbelt
    feedBelt - fedbelt
    belt0 belt1  - belt
    pu0 pu1 pu2 pu3 - procunit
    block0 block1 block2 block3 block4 block5 block6 - block
)
...
(:goal (and
(processed block4 pu1) (processed block2 pu1) (finished block5) (processed block5 pu0) (finished block2) (finished block6) (finished block1) (processed block3 pu3) (processed block0 pu1) (finished block0) (finished block4) (processed block6 pu2) (finished block3) (processed block1 pu2) ))
)
