(define (problem pb8) (:domain prodcell)
(:objects 
    depositbelt - depbelt
    feedBelt - fedbelt
    belt0 belt1  - belt
    pu0 pu1 pu2 pu3 - procunit
    block0 block1 block2 block3 block4 block5 block6 block7 - block
)
...
(:goal (and
(finished block5) (processed block5 pu0) (finished block6) (finished block2) (processed block7 pu1) (finished block1) (processed block2 pu0) (finished block7) (processed block0 pu2) (finished block0) (finished block4) (processed block6 pu2) (processed block1 pu1) (finished block3) (processed block3 pu0) (processed block4 pu3) ))
)
